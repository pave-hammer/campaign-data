exports.up = function(knex, Promise) {
    ...
    return knex('ranks').del()
      .then(function () {
        return knex('ranks').insert([
          ...
          {id: 5, org_id: 2, name: "Arch Maker", description: ""},
          {id: 6, org_id: 2, name: "Maker", description: ""},
          {id: 7, org_id: 2, name: "Guide", description: ""},
        ]);
      });
  })
  ...
  .then(function() {
    return knex('data')
      ...
      .select('data.name as name', 'ranks.name as rank');
  })
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('data').dropTable('ranks');
};
